1. Java can be run using bat file.
...
we can run a program which takes input and throw an output in the console using bat file(.sh file in linux). 
SET /P is used to prompt user with a message and let the user enter an input.
